...
# plot predictions and confidence intervals, lm method in ggplot, shows prediction line
galton_heights %>% ggplot(aes(father, son)) +
  geom_point() +
  geom_smooth(method = "lm")

# predict Y directly, using predict() function that takes lm object (e.g. fit) as input.
...
### Advanced Deplyr
## Broom function to link lm output to tidyverse functions.
# stratify by HR
dat <- Teams %>% filter(yearID %in% 1961:2001) %>%
...
# this algorithm chooses 9 players
our_team <- players %>%
